    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new AlertDialog.Builder(button4.this)
                        .setTitle("결과 확인")
                        ...
                        .setPositiveButton("확인", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Toast.makeText(button4.this, "결과를 확인합니다..", Toast.LENGTH_SHORT).show();
                                if(cnt<=2) {
                                    Intent intent1 = new Intent(button4.this, result10.class);
                                    startActivity(intent1);

                                }
                                else if(cnt>2 && cnt<=4){
                                    Intent intent2 = new Intent(button4.this, result11.class);
                                    startActivity(intent2);
                                }
                                else{
                                    Intent intent3 = new Intent(button4.this, result12.class);
