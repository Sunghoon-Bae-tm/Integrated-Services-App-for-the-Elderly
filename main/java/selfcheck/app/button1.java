...
public class button1 extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn =findViewById(R.id.button09);
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new AlertDialog.Builder(button1.this)
                        .setTitle("결과 확인")
                        ...
                        .setPositiveButton("확인", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Toast.makeText(button1.this, "결과를 확인합니다..", Toast.LENGTH_SHORT).show();
                                if(cnt<=2) {
                                    Intent intent1 = new Intent(button1.this, result1.class);
                                    startActivity(intent1);

                                }
                               else if(cnt>2 && cnt<=4){
                                    Intent intent2 = new Intent(button1.this, result2.class);
                                    startActivity(intent2);
                                }
                                else{
                                    Intent intent3 = new Intent(button1.this, result3.class);
