    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new AlertDialog.Builder(button3.this)
                        .setTitle("결과 확인")
                        ...
                        .setPositiveButton("확인", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Toast.makeText(button3.this, "결과를 확인합니다..", Toast.LENGTH_SHORT).show();
                                if(cnt<=2) {
                                    Intent intent1 = new Intent(button3.this, result7.class);
                                    startActivity(intent1);

                                }
                                else if(cnt>2 && cnt<=4){
                                    Intent intent2 = new Intent(button3.this, result8.class);
                                    startActivity(intent2);
                                }
                                else{
                                    Intent intent3 = new Intent(button3.this, result9.class);
